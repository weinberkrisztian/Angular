...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_product_list_menu_product_list_menu_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./components/product-list-menu/product-list-menu.component */
    "./src/app/components/product-list-menu/product-list-menu.component.ts");
    /* harmony import */


    var _components_search_list_search_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_product_list_menu_product_list_menu_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./components/product-list-menu/product-list-menu.component */
    "./src/app/components/product-list-menu/product-list-menu.component.ts");
    /* harmony import */


    var _components_search_list_search_list_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./components/search-list/search-list.component */
    "./src/app/components/search-list/search-list.component.ts");
    /* harmony import */


    var _components_product_detail_list_product_detail_list_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./components/product-detail-list/product-detail-list.component */
    ...
    /*! @angular/forms */
    "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js"); // declaring the routes and also importing them(RouterModule)
    ...
    var routes = [{
      ...
      path: 'products/:id',
      component: _components_product_detail_list_product_detail_list_component__WEBPACK_IMPORTED_MODULE_9__["ProductDetailListComponent"]
    }, {
      path: 'search/:keyword',
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _components_product_list_product_list_component__WEBPACK_IMPORTED_MODULE_3__["ProductListComponent"], _components_product_list_menu_product_list_menu_component__WEBPACK_IMPORTED_MODULE_7__["ProductListMenuComponent"], _components_search_list_search_list_component__WEBPACK_IMPORTED_MODULE_8__["SearchListComponent"], _components_product_detail_list_product_detail_list_component__WEBPACK_IMPORTED_MODULE_9__["ProductDetailListComponent"], _components_cart_status_cart_status_component__WEBPACK_IMPORTED_MODULE_11__["CartStatusComponent"], _components_cart_details_cart_details_component__WEBPACK_IMPORTED_MODULE_12__["CartDetailsComponent"], _components_checkout_checkout_component__WEBPACK_IMPORTED_MODULE_13__["CheckoutComponent"]],
  ...
  function srcAppComponentsCartDetailsCartDetailsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function CartDetailsComponent_div_3_tr_8_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CartDetailsComponent_div_3_tr_8_Template_button_click_15_listener() {
          ...
          var tempCatrItem_r12 = ctx.$implicit;

          var ctx_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r13.incrementQuantity(tempCatrItem_r12);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CartDetailsComponent_div_3_tr_8_Template_button_click_20_listener() {
          ...
          return ctx_r15.decrementQuantity(tempCatrItem_r12);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CartDetailsComponent_div_3_tr_8_Template_button_click_26_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r14);
          ...
          return ctx_r16.remove(tempCatrItem_r12);
        });
    ...
    CartDetailsComponent.ɵfac = function CartDetailsComponent_Factory(t) {
      return new (t || CartDetailsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_service_cart_service__WEBPACK_IMPORTED_MODULE_1__["CartService"]));
    };
    ...
    CartDetailsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 2,
      consts: [[1, "main-content"], [1, "section-content", "section-content-p30"], [1, "container-fliud"], [4, "ngIf"], ["class", "alert alert-warning col-md-12", "role", "alert", 4, "ngIf"], [1, "table", "table-bordered"], ["width", "20%"], ["width", "50%"], ["width", "30%"], [4, "ngFor", "ngForOf"], ["colspan", "2"], [2, "font-weight", "bold"], ["routerLink", "/checkout", 1, "btn", "btn-primary"], ["width", "150px", 1, "imagge-responsive", 3, "src"], [1, "items"], [1, "row", "no-gutters"], [1, "col"], [1, "btn", "btn-primary", "btn-sm", 3, "click"], [1, "fas", "fa-plus"], [1, "col", "ml-4", "mr-2"], [1, "fas", "fa-minus"], [1, "col-8"], [1, "mt-2"], ["role", "alert", 1, "alert", "alert-warning", "col-md-12"]],
  ...
  function srcAppComponentsCartStatusCartStatusComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CartStatusComponent = /*#__PURE__*/function () {
      ...
      _createClass(CartStatusComponent, [{
        ...
        value: function updateCartStatus() {
          ...
          this.cartService.totalPrice.subscribe(function (data) {
            _this2.totalPrice = data;
          });
          this.cartService.totalQuantity.subscribe(function (data) {
            _this2.totalQuantity = data;
          });
        }
      }]);
    ...
    CartStatusComponent.ɵfac = function CartStatusComponent_Factory(t) {
      return new (t || CartStatusComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_service_cart_service__WEBPACK_IMPORTED_MODULE_1__["CartService"]));
    };
  ...
  function srcAppComponentsCheckoutCheckoutComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_service_checkout_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/app/service/checkout.service */
    ...
    function CheckoutComponent_option_39_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CheckoutComponent_option_85_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "option", 36);
    ...
    function CheckoutComponent_option_107_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "option");
    ...
    function CheckoutComponent_option_157_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "option");
    ...
    function CheckoutComponent_option_165_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "option");
    ...
    var CheckoutComponent = /*#__PURE__*/function () {
      function CheckoutComponent(formBuilder, cartService, checkoutService) {
      ...
      _createClass(CheckoutComponent, [{
        ...
        key: "setStatesBilling",
        value: function setStatesBilling(code) {
          var _this3 = this;

          console.log("state:" + code);
          this.checkoutService.getStatesByCountryCode(code).subscribe(function (data) {
            _this3.statesBilling = data;
          });
        }
      }, {
        key: "setStatesShipping",
        value: function setStatesShipping(code) {
          var _this4 = this;

          console.log("state:" + code);
          this.checkoutService.getStatesByCountryCode(code).subscribe(function (data) {
            _this4.statesShipping = data;
          });
        }
      }, {
        key: "copyShippingToBilling",
        value: function copyShippingToBilling(event) {
        ...
        key: "choosingExpirationYear",
        value: function choosingExpirationYear() {
          var _this5 = this;

          var creditCardFormGroup = this.checkoutFormGroup.get('creditCard');
          var selectedYear = Number(creditCardFormGroup.value.expirationYear);
          var startMonth;
          ...
          this.checkoutService.getMonthsForCreditCard(startMonth).subscribe(function (data) {
            _this5.expirationMonthList = data;
          });
        }
      }, {
        key: "onSubmit",
        ...
        key: "showPriceAndQuantityStatus",
        value: function showPriceAndQuantityStatus() {
          var _this6 = this;

          this.cartService.totalPrice.subscribe(function (data) {
            _this6.totalPrice = data;
          });
          this.cartService.totalQuantity.subscribe(function (data) {
            _this6.totalQuantity = data;
          });
          this.cartService.computeCartTotalts();
          this.checkoutService.getYearForCreditCard().subscribe(function (data) {
            _this6.expirationYearList = data;
          });
          this.checkoutService.getMonthsForCreditCard(this.startMonth).subscribe(function (data) {
            _this6.expirationMonthList = data;
          });
          this.checkoutService.getCountryList().subscribe(function (data) {
            _this6.countriesBilling = data;
          });
        }
      }]);
    ...
    CheckoutComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function CheckoutComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function CheckoutComponent_Template_select_change_37_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r31);

            var _r17 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](38);

            return ctx.setStatesShipping(_r17.value);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function CheckoutComponent_Template_input_change_71_listener($event) {
            return ctx.copyShippingToBilling($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function CheckoutComponent_Template_select_change_83_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r31);

            var _r20 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](84);

            return ctx.setStatesBilling(_r20.value);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function CheckoutComponent_Template_select_change_164_listener() {
            return ctx.choosingExpirationYear();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CheckoutComponent, [{
        ...
        return [{
          ...
          type: src_app_service_checkout_service__WEBPACK_IMPORTED_MODULE_3__["CheckoutService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppComponentsProductDetailListProductDetailListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProductDetailListComponent", function () {
      return ProductDetailListComponent;
    });
    /* harmony import */
    ...
    var ProductDetailListComponent = /*#__PURE__*/function () {
      function ProductDetailListComponent(productService, route, cartService) {
        _classCallCheck(this, ProductDetailListComponent);
      ...
      _createClass(ProductDetailListComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this7 = this;

          this.route.paramMap.subscribe(function () {
            _this7.getProductById();
          });
        }
      }, {
        key: "addToCart",
        value: function addToCart() {
          var cartItem = new src_app_common_cart_item__WEBPACK_IMPORTED_MODULE_2__["CartItem"](this.product);
          this.cartService.addToCart(cartItem);
        }
      }, {
        key: "getProductById",
        value: function getProductById() {
          ...
          this.productService.getProductByIdService(theId).subscribe(function (data) {
            _this8.product = data;
          });
        }
      }]);
    ...
    ProductDetailListComponent.ɵfac = function ProductDetailListComponent_Factory(t) {
      return new (t || ProductDetailListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_service_product_service_service__WEBPACK_IMPORTED_MODULE_3__["ProductServiceService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_service_cart_service__WEBPACK_IMPORTED_MODULE_5__["CartService"]));
    };

    ProductDetailListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ProductDetailListComponent,
      selectors: [["app-product-detail-list"]],
      decls: 17,
      vars: 7,
      consts: [[1, "detail-section"], [1, "container-fluid"], [1, "detail-img", 3, "src"], [1, "price"], [1, "btn", "btn-outline-primary", "btn-sm", 3, "click"], ["routerLink", "/products", 1, "mt-5"]],
      template: function ProductDetailListComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductDetailListComponent_Template_button_click_8_listener() {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProductDetailListComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsProductListMenuProductListMenuComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProductListMenuComponent", function () {
      return ProductListMenuComponent;
    });
    /* harmony import */
    ...
    var src_app_service_product_service_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! src/app/service/product-service.service */
    "./src/app/service/product-service.service.ts");
    /* harmony import */
    ...
    function ProductListMenuComponent_li_3_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var tempCategory_r6 = ctx.$implicit;
    ...
    var ProductListMenuComponent = /*#__PURE__*/function () {
      function ProductListMenuComponent(productService) {
        _classCallCheck(this, ProductListMenuComponent);

        this.productService = productService;
      }

      _createClass(ProductListMenuComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.listOfProductListCategories();
        }
      }, {
        key: "listOfProductListCategories",
        value: function listOfProductListCategories() {
          var _this9 = this;

          this.productService.getProducCategoryList().subscribe(function (data) {
            console.log("The incomming data" + JSON.stringify(data));
            _this9.productCategory = data;
          });
        }
      }]);
    ...
    ProductListMenuComponent.ɵfac = function ProductListMenuComponent_Factory(t) {
      return new (t || ProductListMenuComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_service_product_service_service__WEBPACK_IMPORTED_MODULE_1__["ProductServiceService"]));
    };

    ProductListMenuComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ProductListMenuComponent,
      selectors: [["app-product-list-menu"]],
      decls: 4,
      vars: 1,
      consts: [[1, "menu-sidebar-content", "js-scrollbar1"], [1, "navbar-sidebar"], [1, "list-unstyled", "navbar-list"], [4, "ngFor", "ngForOf"], ["routerActiveLink", "active-link", 3, "routerLink"]],
      template: function ProductListMenuComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProductListMenuComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          type: src_app_service_product_service_service__WEBPACK_IMPORTED_MODULE_1__["ProductServiceService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppComponentsProductListProductListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function ProductListComponent_div_7_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductListComponent_div_7_Template_button_click_11_listener() {
    ...
    var ProductListComponent = /*#__PURE__*/function () {
      function ProductListComponent(productService, cartService, route) {
        ...
        this.searchMode = false; //for pagination

        this.thePageNumber = 1;
        this.thePageSize = 5;
        this.theTotalElements = 0;
        this.maxSize = 3;
        this.boundaryLinks = true; // pagination search
      ...
      _createClass(ProductListComponent, [{
        ...
        key: "updatePageSize",
        value: function updatePageSize(thePageSize) {
        ...
        key: "listProductsBySearch",
        value: function listProductsBySearch() {
          var theKeyword = this.route.snapshot.paramMap.get('keyword');
        ...
        key: "listProductsByCategory",
        value: function listProductsByCategory() {
          var hasId = this.route.snapshot.paramMap.has('id'); // check if the id is empty or not
          ...
          console.log("the previous category id: ".concat(this.previousCategoryId, " and the current: ").concat(this.curretnCategoryId));
        ...
        key: "processResultWithPagination",
        value: function processResultWithPagination() {
          var _this11 = this;

          return function (data) {
            _this11.products = data._embedded.products;
            _this11.thePageNumber = data.page.number + 1;
            _this11.thePageSize = data.page.size;
            _this11.theTotalElements = data.page.totalElements;
          };
        }
      }, {
        key: "addToCart",
        value: function addToCart(tempProduct) {
          console.log("name: ".concat(tempProduct.name, " price: ").concat(tempProduct.unitPrice));
          var theCartItem = new src_app_common_cart_item__WEBPACK_IMPORTED_MODULE_1__["CartItem"](tempProduct);
    ...
    ProductListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 32,
      vars: 8,
      consts: [[1, "main-content"], [1, "section-content", "section-content-p30"], [1, "font-weight-bold"], [1, "container-fluid"], [1, "row"], ["class", "col-md-3", 4, "ngFor", "ngForOf"], ["class", "alert alert-warning col-md-12 d-flex justify-content-center", "role", "alert", 4, "ngIf"], [1, "footer-pagination"], [1, "col-md-6"], [1, "col-md-9", 2, "padding-left", "30%"], [3, "page", "pageSize", "collectionSize", "maxSize", "boundaryLinks", "pageChange"], [1, "col-md-3", "mt-2", 2, "text-align", "right"], [1, "mr-2"], [3, "change"], ["selected", "true"], [1, "col-md-3"], [1, "product-box"], ["routerActiveLink", "active-link", 3, "routerLink"], [1, "img-responsive", 3, "src"], [3, "routerLink"], [1, "price"], [1, "btn", "btn-outline-primary", "btn-sm", 3, "click"], ["role", "alert", 1, "alert", "alert-warning", "col-md-12", "d-flex", "justify-content-center"]],
      template: function ProductListComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("pageChange", function ProductListComponent_Template_ngb_pagination_pageChange_15_listener($event) {
            return ctx.thePageNumber = $event;
          })("pageChange", function ProductListComponent_Template_ngb_pagination_pageChange_15_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function ProductListComponent_Template_select_change_19_listener($event) {
  ...
  function srcAppComponentsSearchListSearchListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SearchListComponent = /*#__PURE__*/function () {
      ...
      _createClass(SearchListComponent, [{
        ...
        value: function searchForProduct(value) {
    ...
    SearchListComponent.ɵfac = function SearchListComponent_Factory(t) {
      return new (t || SearchListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]));
    };
    ...
    SearchListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 0,
      consts: [[1, "form-header"], ["type", "text", "placeholder", "Search for product ...", 1, "au-input", "au-input-xl", 3, "keyup.enter"], ["myInput", ""], [1, "au-btn-submit", 3, "click"]],
      template: function SearchListComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keyup.enter", function SearchListComponent_Template_input_keyup_enter_1_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8);

            var _r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](2);

            return ctx.searchForProduct(_r7.value);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SearchListComponent_Template_button_click_3_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SearchListComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  function srcAppServiceCartServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CartService = /*#__PURE__*/function () {
      ...
      _createClass(CartService, [{
        ...
        key: "computeCartTotalts",
        value: function computeCartTotalts() {
        ...
        value: function logCartData(totalPriceValue, totalQuantityValue) {
          ...
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              var tempItem = _step2.value;
              var subTotal = tempItem.quantity * tempItem.unitPrice;
              console.log("Name: ".concat(tempItem.name, " Price: ").concat(tempItem.unitPrice, " Quantity: ").concat(tempItem.quantity, " subtotal: ").concat(tempItem.unitPrice * tempItem.quantity) + " subtotal".concat(subTotal));
            }
          } catch (err) {
            _iterator2.e(err);
          } finally {
        ...
        key: "remove",
        value: function remove(cartItem) {
          var theCartIndex = this.CartItems.findIndex(function (tempCartItem) {
  ...
  /***/
  function srcAppServiceCheckoutServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var CheckoutService = /*#__PURE__*/function () {
      ...
      _createClass(CheckoutService, [{
        key: "getStatesByCountryCode",
        value: function getStatesByCountryCode(code) {
          var urlForStatesFindByCountryCode = "".concat(this.baseurlForstates, "/search/findByCountryCode?code=").concat(code);
          return this.httpClient.get(urlForStatesFindByCountryCode).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (response) {
        ...
        value: function getCountryList() {
          return this.httpClient.get(this.baseurlForCountries).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (response) {
            return response._embedded.countries;
          }));
        }
      }, {
        key: "getMonthsForCreditCard",
        value: function getMonthsForCreditCard(startMonth) {
          var data = [];
        ...
        key: "getYearForCreditCard",
        value: function getYearForCreditCard() {
          var data = [];
  ...
  function srcAppServiceProductServiceServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProductServiceService = /*#__PURE__*/function () {
      function ProductServiceService(httpClient) {
        ...
        this.httpClient = httpClient;
        this.categorySearchUrl = 'http://localhost:8080/api/product-category'; //  private baseurl='http://localhost:8080/api/products?size=100';
      ...
      _createClass(ProductServiceService, [{
        ...
        value: function getProductListPaginate(thePage, thePageSize, currentCategoryId) {
          // we have to make that URL access on the backend side
          var searchUrl = "".concat(this.baseurl, "/search/findByCategoryId?id=").concat(currentCategoryId) + "&page=".concat(thePage, "&size=").concat(thePageSize);
          return this.httpClient.get(searchUrl);
        }
      }, {
        key: "getProductList",
        value: function getProductList(currentCategoryId) {
          // we have to make that URL access on the backend side
          var searchUrl = "".concat(this.baseurl, "/search/findByCategoryId?id=").concat(currentCategoryId);
          return this.httpClient.get(searchUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (response) {
            return response._embedded.products;
          }));
        }
      }, {
        key: "getProducCategoryList",
        value: function getProducCategoryList() {
          return this.httpClient.get(this.categorySearchUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (response) {
            return response._embedded.productCategory;
          }));
        }
      }, {
        key: "getSearchProduct",
        value: function getSearchProduct(thePage, thePageSize, theKeyword) {
          var searchedUrl = "".concat(this.baseurl, "/search/findByNameContaining?name=").concat(theKeyword) + "&page=".concat(thePage, "&size=").concat(thePageSize);
          return this.httpClient.get(searchedUrl);
        }
      }, {
        key: "getProductByIdService",
        value: function getProductByIdService(theId) {
          var detailedUrl = "".concat(this.baseurl, "/").concat(theId);
    ...
    ProductServiceService.ɵfac = function ProductServiceService_Factory(t) {
      return new (t || ProductServiceService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]));
    };
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! I:\FullStackKurzus\FrontEnd\angular-ecommerce\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
